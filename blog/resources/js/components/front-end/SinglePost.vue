                    ...
                    <div class="span8">
                        <article>
                            <div class="row">
                                <div class="span8">
                                    ...
                                    <blockquote>
                                        <i class="icon-quote-left"></i> Lorem ipsum dolor sit amet, ei quod constituto
                                        qui. Summo labores expetendis ad quo, lorem luptatum et vis. No qui vidisse
                                        signiferumque...
                                    </blockquote>
                                    <p v-html="post.post_description">
                                    ...
                                    <div class="bottom-article">
                                        <ul class="meta-post">
                                            ...
                                            <li v-if="post.category"><i class="icon-tags"></i><a href="#">{{post.category.category_name}}</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="about-author">
                            ...
                            <p>
                                ...
                                ocurreret pertinacia pri an. No mei nibh consectetuer, semper ad qui, est rebum nulla
                                argumentum ei.
                            </p>
                        </div>
                            ...
                            <form id="commentform" action="#" method="post" name="comment-form">
                                <div class="row">
                                    ...
                                    <div class="span8 margintop10">
                                        <p>
                                            <textarea rows="12" class="input-block-level"
                                                      placeholder="*Your comment here"></textarea>
                                        </p>
                                        <p>
                                            <button class="btn btn-theme margintop10" type="submit">Submit comment
                                            </button>
                                        </p>
                                    </div>
                                </div>
